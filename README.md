...
侧边栏的“单明手最佳首攻”为可选功能，默认关闭。模拟默认 1000 次，可选 250、1000、2500、5000 次或自定义 16–5000 次。可编辑各家大牌点、花色长度、牌型、持有/排除大牌和庄明联手点力；支持首次自然开叫模板填充，尚未接入完整叫牌引擎。点击“开始首攻分析”后，后台 Worker 自动从原始发牌生成临时单明手数据，仅保留首攻方 13 张牌，按约束采样其余三家。无需创建副本，不新增牌例、不改变牌桌或播放进度；关闭后继续原来的基本分析。历史版本已保存的副本仍可手动删除。详细边界见 [首攻约束对照](docs/lead-analysis-comparison.md)。
