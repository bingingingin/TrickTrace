...
def render(index,angle=None,font=None):
 ...
 angle=random.choice([0,0,0,random.uniform(-50,50)]) if angle is None else angle
...
if __name__=='__main__':
 out=root/'.cache/models-v3';out.mkdir(parents=True,exist_ok=True)
 cache=root/'.cache/glyphs-v3.npz'
 if cache.exists():
